<template>
  <div class="hero-inner">
    ...
    <p class="subtitle">.NET &middot; Developer</p>
    <p class="subtitle">Apprentice computer science expert for application development</p>
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      gsap.from('.subtitle', { y: -10, opacity: 0, duration: 1, delay: 0.2 })
      gsap.from('.btn', { scale: 0.9, opacity: 0, duration: 0.8, stagger: 0.08, delay: 0.4 })
    })
    return { root }
  }
}
